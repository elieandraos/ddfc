  ...
  <div class="container" >
    <div class="row" style="padding-top:35px;">
        <div class="col-sm-2">
            ...
            <p>{{trans('messages.the higher committee')}}</p>
            <p>{{trans('messages.Strategy')}}</p>
        </div>
        <div class="col-sm-2">
            <h4>{{trans('messages.Goals')}}</h4><br/>
            <p>{{trans('messages.Health')}}</p>
            <p>{{trans('messages.Education')}}</p>
            <p>{{trans('messages.Employment')}}</p>
            <p>{{trans('messages.Universal Accessibility')}}</p>
            <p>{{trans('messages.Social Protection')}}</p>
        </div>
        <div class="col-sm-2">
            <h4>{{trans('messages.Voices')}}</h4><br/>
            <p>{{trans('messages.Success Stories')}}</p>
